...
<head>
  ...
  <style>
    ...
    .gal-track { scroll-padding-left: 1.5rem; }
    .gal-track > div { scroll-snap-align: start; }
    @media (max-width: 767px) {
      .gal-track > div { flex: 0 0 78%; }
    }
    @media (min-width: 560px) and (max-width: 767px) {
      .gal-track > div { flex-basis: 46%; }
    }
  ...
  <section id="depoimentos" class="py-24 px-6 bg-[#131628]/50">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8" data-aos="fade-up" data-aos-delay="80">
        ...
        <div class="gal-track flex md:grid md:grid-cols-3 gap-3 overflow-x-auto md:overflow-visible snap-x snap-mandatory no-scrollbar -mx-6 px-6 md:mx-0 md:px-0 pb-2 md:pb-0">
