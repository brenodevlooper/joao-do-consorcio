      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div data-aos="fade-left">
          ...
          <p class="text-white/60 leading-relaxed mb-4">
            João Vitor é especialista em consórcio de veículos com mais de 8 anos de experiência. Reconhecido como <strong class="text-white">"Fera de Consórcio 2024"</strong>, ele já ajudou mais de 360 famílias a realizarem o sonho do veículo próprio — sem pagar juros.
          </p>
          ...
          <div class="flex flex-wrap gap-3">
            <div class="flex items-center gap-2 bg-[#131628] border border-white/8 rounded-xl px-4 py-3 text-sm font-medium">
              <i class="fas fa-trophy text-brand-orange"></i> Fera de Consórcio 2024
            </div>
            <div class="flex items-center gap-2 bg-[#131628] border border-white/8 rounded-xl px-4 py-3 text-sm font-medium">
